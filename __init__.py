...
class IMPORT_MT_ymp(bpy.types.Menu):
	...
	def draw(self, context):
		...
		layout.operator("import_scene.ymp_model_pc", text="PC (.YMXEN, .JBOY, .YOBJ)")
		layout.operator("import_scene.ymp_model_xbox", text="XBOX (.YMXEN, .JBOY)")
		layout.operator("import_scene.ymp_model_gamecube", text="GameCube (.YMP, .YOBJ)")
		layout.operator("import_scene.ymp_model_psp", text="PSP (.YMP, .YOBJ)")
